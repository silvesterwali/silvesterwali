...
export function usePromos() {
  const item = ref<PromoPackage>({
    ...
    description:
      "Anda ingin bangun kepercayaan terhadap bisnis anda ? kami siap membantu Anda dengan solusi website profesional.",
    headline: "Promo",
    costs: [
      {
      ...
      },
      {
        ...
        amount: "Rp 100.000",
        description:
          "per bulan di tahun pertama (mencakup update keamanan, monitoring, dan perbaikan kecil)",
      },
    ],
    features: [
      {
    ...
    advantages: [
      ...
      },
      {
        ...
        description:
          "Setelah tahun pertama, akan di evaluasi ulang berdasarkan trafik dan kebutuhan website, yang bisa dinegosiasikan kembali",
      },
    ],
    contact: {
      name: "Silvester Wali",
