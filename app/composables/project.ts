...
export function useProjects() {
  const items = ref<ProjectShowcase[]>([
    ...
    },
    {
      ...
      description:
        "SaaS landing pages focused on conversion performance. Built with Nuxt & Tailwind CSS.",
    ...
    },
    {
      ...
      description:
        "An organization website built for Sopan Sumba using Nuxt.js, Tailwind CSS, and Nitro.",
    ...
    },
    {
      ...
      description:
        "A full-featured e-commerce website built with Nuxt.js, Tailwind CSS, and Laravel for backend services.",
    ...
    },
    {
      ...
      description:
        "A travel agent website for Luxbali, built with Nuxt.js, Tailwind CSS, and Nitro.",
